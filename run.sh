...
#SBATCH -o /homes/ilyubnn/work/slurm/job_name-%x.job_number-%j.nodes-%N.out
#SBATCH -e /homes/ilyubnn/work/slurm/job_name-%x.job_number-%j.nodes-%N.err
#SBATCH -p lowgpu
#SBATCH --nodes=1
...
#export MODEL_NAME=howey/bert-base-uncased-sst2
