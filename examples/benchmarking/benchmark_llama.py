...
from benchmark import measure_model_runtime,measure_model_error,EVALUATION_MODE
...
def llama_model_maker():
    ...
    def model_runner(m):
        return pipe(text_inputs="The unanimous Declaration of the thirteen united States of America, ", max_new_tokens=1)
