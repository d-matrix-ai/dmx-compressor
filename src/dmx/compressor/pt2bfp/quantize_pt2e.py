...
from dmx.compressor.pt2bfp.quantizer import (  # noqa: F401
    BFPQuantizer,
    BFPQuantizationSpec,
...
_QUANT_OPS = [
    torch.ops.quant_decomposed.quantize_per_tensor.default,
    torch.ops.quant_decomposed.quantize_per_tensor.tensor,
    torch.ops.quant_decomposed.quantize_per_channel.default,
]
